...
net_wired = net_widgets.indicator({interfaces = {"enp0s25", "lo"}, timeout = 30 , font = theme.font})
-- Weather
--[[
local weathericon = 
wibox.widget.imagebox(theme.widget_weather)
