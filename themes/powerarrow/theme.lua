...
--[[ Binary clock
local textclock = require("themes.powerarrow.textclock"){
    height = 16,
    show_seconds = false,
...
calendar.addCalendarToWidget(textclock)
--[[ Calendar
...
--Create the bottom wibox (contains the active apps)
  ...
  s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, height = 18, bg = theme.bg_normal, fg = theme.fg_normal })
	...
	spr,
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#343434"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon ,theme.volume, layout = wibox.layout.align.horizontal }, 2, 3), "#343434"),
	    ...
	    --wibox.container.background(wibox.container.margin(task, 3, 7), "#343434"),
	      ...
	      --wibox.container.background(wibox.container.margin(wibox.widget { nil, net_w, layout = wibox.layout.align.horizontal }, 3, 3), "#ADBF8B"),
	    arrow("#8DAA9A","#C0C0A2"),
	    ...
	    wibox.container.background(wibox.container.margin(wibox.widget { nil, net_w, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#C0C0A2"),
            arrow("#C0C0A2", "#777E76"),
